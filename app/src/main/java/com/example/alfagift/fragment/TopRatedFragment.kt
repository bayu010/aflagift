...
class TopRatedFragment: CoreFragment() {
    override val viewBinding by lazy { LayoutMovieListBinding.inflate(layoutInflater) }
    private val viewModel by lazy { TopRatedViewModel() }
    ...
    private fun initView(){
        viewBinding.tvMovieCategory.text = resources.getString(R.string.text_top_rated)
